"""
Django settings for dropchan project.
...
SECRET_KEY = '1*%sc1_1rnnc9s^86k@i)2cqwdx&2rc1)93+xy9@_992!kodd)'
...
WSGI_APPLICATION = 'dropchan.wsgi.application'
...
# Dropbox file structure for comments:
